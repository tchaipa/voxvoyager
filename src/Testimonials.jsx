    ...
    <div className="testimonials-section container-fluid">
      ...
      <div className="testimonials-container container-fluid">
        <Row className="testimonials-row">
          <Col>
            <Card className="testimonials-card">
              <p>
                " Voxvoyager simply are the best. Definitely using their
                services all the time when i visit. I really enjoyed my stay in
                Zimbabwe"
              </p>
          ...
          <Col>
            <Card className="testimonials-card">
              <p>
                " We really had a great time in Vumba all thanks to the
                wonderfull team at VoxVoyager who made our journey a memorable
                one."
              </p>
        ...
        <div className="test-button">
          <Button className="testimonials-button" href="testimonies">
            Read More
          </Button>
        </div>
      </div>
