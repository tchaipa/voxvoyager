    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          const hasBgImage = Boolean(card.image);
          const baseClassName = `magic-bento-card ${textAutoHide ? "magic-bento-card--text-autohide" : ""} ${enableBorderGlow ? "magic-bento-card--border-glow" : ""} ${hasBgImage ? "magic-bento-card--has-bg-image" : ""}`;
          const cardProps = {
            className: baseClassName,
            style: {
              ...(card.color && !hasBgImage && { backgroundColor: card.color }),
              ...(hasBgImage && {
